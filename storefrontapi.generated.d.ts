...
export type GlobeLinkQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  menuHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type GlobeLinkQuery = {
  menu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
...
export type NewsletterPageQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GlobeLink(\n    $country: CountryCode\n    $menuHandle: String!\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    menu(handle: $menuHandle) {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: GlobeLinkQuery;
    variables: GlobeLinkQueryVariables;
  };
  ...
  '#graphql \n  query NewsletterPage {  \n    metaobjects(type: "newsletter_page" first: 1) {\n      nodes {\n        seo {\n          title {\n            value\n          }\n          description {\n            value\n          }\n        }\n        fields {\n          key\n          value\n          reference {\n              __typename\n              ... on Video {\n                mediaContentType\n                previewImage {\n                  height\n                  width\n                  url\n                  altText\n                }\n                sources {\n                  url\n                  mimeType\n                  height\n                  width\n                  \n                }\n              }\n              ... on MediaImage {\n                image {\n                  url\n                  width\n                  height\n                  altText\n                }\n              }\n\n            }\n        }\n      }\n    }\n  }\n': {
    return: NewsletterPageQuery;
    variables: NewsletterPageQueryVariables;
  };
